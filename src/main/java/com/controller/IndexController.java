...
public class IndexController {
    ...
    public ServiceResult getMainData(@RequestParam( value = "authCode" ) String requestAuthCode, HttpServletRequest servletRequest) {
        ...
        if ( userById == null )
            userMapper.insert(userId, userName.getName(), userName.getAvatar(), kaoqinzu,userName.getMobile(), userName.getEmail().substring(0, userName.getEmail().indexOf("@")), userName.getEmail());
